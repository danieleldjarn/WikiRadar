...
static void prv_window_load(Window *window) {
  ...
  prv_format_coord(g_articles[s_index].lat, lat_buf, sizeof(lat_buf));
  prv_format_coord(g_articles[s_index].lon, lon_buf, sizeof(lon_buf));
